  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <TouchableOpacity 
          style={[styles.emergencyCard, { backgroundColor: colors.danger + '12' }]}
          onPress={() => setShowEmergencyModal(true)}
          activeOpacity={0.8}
        >
          <View style={styles.emergencyCardContent}>
            <View style={[styles.emergencyIconContainer, { backgroundColor: colors.danger + '20' }]}>
              <Ionicons name="medkit" size={28} color={colors.danger} />
            </View>
            <View style={styles.emergencyCardText}>
              <Text style={[styles.emergencyCardTitle, { color: colors.text }]}>
                {t('emergencyInfo')}
              </Text>
              <Text style={[styles.emergencyCardSub, { color: colors.textSecondary }]}>
                {profile.insurances.length > 0 
                  ? `${profile.insurances.length} ${profile.insurances.length === 1 ? 'policy' : 'policies'} saved`
                  : t('tapToAddInfo')}
              </Text>
            </View>
            <View style={[styles.emergencyBadge, { backgroundColor: colors.danger }]}>
          ...
          <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <View style={styles.emergencyModalHeader}>
                ...
                <Text style={[styles.modalTitle, { color: colors.text }]}>{t('emergencyInfo')}</Text>
              </View>
            ...
            <ScrollView style={{ maxHeight: '80%' }}>
              ...
              <View style={styles.emergencySection}>
                ...
                {profile.insurances.length > 0 ? (
                  profile.insurances.map((insurance, index) => (
                    ...
                    >
                      <View style={styles.emergencyItemHeader}>
                        <View style={[
                          styles.insuranceTypeBadge, 
                          { backgroundColor: insurance.type === 'medical' ? colors.danger + '20' : colors.primary + '20' }
                        ]}>
                          <Ionicons 
                            name={insurance.type === 'medical' ? 'medical' : 'airplane'} 
                            size={14} 
                          ...
                          <Text style={[
                            ...
                            {insurance.type === 'medical' ? t('medicalInsurance') : t('travelInsurance')}
                          </Text>
                        </View>
                      </View>
                      <Text style={[styles.emergencyItemTitle, { color: colors.text }]}>
                        {insurance.provider}
                      </Text>
                      <View style={styles.emergencyItemRow}>
                        <Ionicons name="document-text-outline" size={14} color={colors.textSecondary} />
                        <Text style={[styles.emergencyItemDetail, { color: colors.textSecondary }]}>
                      ...
                      {insurance.phone && (
                        <View style={styles.emergencyItemRow}>
                          ...
                          <Text style={[styles.emergencyItemPhone, { color: colors.success }]}>
                            {insurance.phone}
                          </Text>
                        </View>
                      )}
                      {insurance.notes && (
                        <Text style={[styles.emergencyItemNotes, { color: colors.textSecondary }]}>
                          {insurance.notes}
                        </Text>
                      )}
                    </View>
                  ...
                  <View style={[styles.emptyEmergency, { backgroundColor: colors.background }]}>
                    <Ionicons name="shield-outline" size={40} color={colors.textSecondary} />
                    <Text style={[styles.emptyEmergencyText, { color: colors.textSecondary }]}>
                      {t('noInsuranceAdded')}
                    </Text>
                    <TouchableOpacity
                      style={[styles.addEmergencyButton, { backgroundColor: colors.primary }]}
                      onPress={() => {
                    ...
                    >
                      <Ionicons name="add" size={18} color="#FFFFFF" />
                      <Text style={styles.addEmergencyButtonText}>{t('addInsurance')}</Text>
                    </TouchableOpacity>
                  </View>
                )}
              </View>
                    ...
                    return (
                      ...
                      >
                        <View style={styles.passportHeader}>
                          <Text style={styles.passportFlag}>{country?.flag}</Text>
                          <View style={styles.passportInfo}>
                            <Text style={[styles.emergencyItemTitle, { color: colors.text }]}>
                              {country?.name}
                            </Text>
                            <Text style={[styles.passportNumber, { color: colors.textSecondary }]}>
                              {passport.passportNumber}
                            </Text>
                          </View>
                          {isExpired && (
                            <View style={[styles.expiryBadge, { backgroundColor: colors.danger }]}>
                              <Text style={styles.expiryBadgeText}>{t('expired')}</Text>
                            </View>
                          )}
                          {isExpiringSoon && !isExpired && (
                            <View style={[styles.expiryBadge, { backgroundColor: colors.warning }]}>
                              <Text style={styles.expiryBadgeText}>{daysUntilExpiry}d</Text>
                            </View>
                          )}
                        </View>
                        <View style={styles.emergencyItemRow}>
              ...
              {/* Quick Tips */}
              <View style={[styles.emergencyTips, { backgroundColor: colors.primary + '10' }]}>
                <View style={styles.emergencyTipsHeader}>
                  <Ionicons name="bulb" size={18} color={colors.primary} />
                  <Text style={[styles.emergencyTipsTitle, { color: colors.primary }]}>
                    {t('emergencyTips')}
                  </Text>
                </View>
                <Text style={[styles.emergencyTipsText, { color: colors.text }]}>
                  {t('emergencyTip1')}
                </Text>
                <Text style={[styles.emergencyTipsText, { color: colors.text }]}>
                  {t('emergencyTip2')}
